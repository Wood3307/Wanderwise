...
test('bundled snapshot has traceable real authors and excerpts for explicit public browsing', async () => {
  ...
  const response = await service.explore('', 'public');
